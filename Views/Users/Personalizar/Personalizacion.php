...
<div class="ui container">
    ...
    <body>
        <form action="Recibirdatos.php" class="ui  form" method="POST">
            <!-- Fila numero uno ¡-->
            ...
            <div class="two fields">
                ...
                <div class="field">
                    ...
                    <input type="file" name="PrototipoDeReferencia">
                </div>
            </div>
            <br><br>
                ...
                <div class="field">
                    ...
                    <div class="ui message">
                        <textarea name="Descripcion" rows="2" cols="30"
                            placeholder="ESCRIBE COMO LO QUIERES:"></textarea>
                    </div>
                </div>
                <br>
                <div class="field">
            ...
            <div class="ui  center aligned container">
                <div class="large ui buttons">
                    <button type="submit" class="ui inverted primary button">Enviar Datos</button>
                    <button type="reset" class="ui red button">Eliminar Datos Escritos</button>
                    <button type="" class="ui inverted primary button">Imprimir Constancia de Personalización</button>
                </div>
            </div>
        </form>
        <br>
