        ...
        <form action="Actualizar.php" class="ui form" method="POST">
            ...
            <div class="two fields">
                ...
                <div class="field">
                    ...
                    <img src="<?php echo $a->PrototipoDeReferencia; ?>" alt="" width="100px" height="100px">
                </div>
            </div>
            <br><br>
            ...
            <div class="field">
                <div class="field">
                    ...
                    <div class="ui message">
                        <textarea type="text" name="Descripcion" rows="2" cols="30"
                            placeholder="Si Deseas Cambiar Tu Descripcion Acá Lo Puedes Hacer">
                            <?php echo $a->Descripcion; ?></textarea>
                    </div>
                    <br>
                    <div class="field">
